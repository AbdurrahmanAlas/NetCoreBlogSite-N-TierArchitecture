...
namespace BLOGCORE2022.Controllers
{
    public class EmployeeTestController : Controller
    {
        ...
        {
            var httpClient = new HttpClient();
            var responseMessage = await httpClient.GetAsync("https://localhost:44378/api/Default/"+id);
        ...
        public async Task<IActionResult> EditEmployee(Class1 p)
        {
            ...
            var responseMessage = await httpClient.PutAsync("https://localhost:44378/api/Default/", content);
            if(responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> DeleteEmployee(int id)
        {
            ...
            var httpClient = new HttpClient();
            var responseMessage = await httpClient.DeleteAsync("https://localhost:44378/api/Default/" + id);
